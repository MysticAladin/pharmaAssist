    ...
    public partial class AddDomainEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BiHEntities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameLocal = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DescriptionLocal = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    NameLocal = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    BiHEntityId = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cantons_BiHEntities_BiHEntityId",
                        column: x => x.BiHEntityId,
                        principalTable: "BiHEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalInstitution = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    PatientName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    PatientIdNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Prescriptions_Customers_CustomerId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameLocal = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BiHEntityId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerAddresses_BiHEntities_BiHEntityId",
                        column: x => x.BiHEntityId,
                        principalTable: "BiHEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_CustomerAddresses_Cantons_CantonId",
                        column: x => x.CantonId,
                        principalTable: "Cantons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    NameLocal = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    HasControlledSubstanceArea = table.Column<bool>(type: "bit", nullable: false),
                    CapacityCubicMeters = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BiHEntities_Code",
                table: "BiHEntities",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Cantons_BiHEntityId",
                table: "Cantons",
                column: "BiHEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_Cantons_Code",
                table: "Cantons",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerAddresses_BiHEntityId",
                table: "CustomerAddresses",
                column: "BiHEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerAddresses_CantonId",
                table: "CustomerAddresses",
                column: "CantonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryStocks_ProductId_ProductBatchId_WarehouseId",
                table: "InventoryStocks",
                columns: new[] { "ProductId", "ProductBatchId", "WarehouseId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_CustomerId1",
                table: "Prescriptions",
                column: "CustomerId1");

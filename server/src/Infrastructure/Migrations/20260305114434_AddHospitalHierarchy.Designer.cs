...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260305114434_AddHospitalHierarchy")]
    partial class AddHospitalHierarchy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.BrandGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BrandGroups", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.BrandGroupMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BrandGroupMembers", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Campaign", b =>
                {
                    ...
                    b.Property<string>("TargetingCriteria")
                        .HasMaxLength(4000)
            ...
            modelBuilder.Entity("Domain.Entities.CampaignExpense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CampaignExpenses", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.CampaignTarget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Cycle", b =>
                {
                    ...
                    b.Property<string>("FocusBrandIds")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
            ...
            modelBuilder.Entity("Domain.Entities.CycleTarget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CycleId", "CustomerId", "RepId")
                        .IsUnique();

                    b.ToTable("CycleTargets", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Department", b =>
                {
                    ...
                    b.Property<int?>("HeadPhysicianId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.ExecutedVisit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DistanceFromCustomerMeters")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PlannedVisitId")
                        .HasColumnType("int");

                    b.Property<string>("ProductsDetailedDiscussion")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
                    ...
                    b.HasIndex("RepId", "CheckInTime");

                    b.ToTable("ExecutedVisits", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.MaterialDistribution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MaterialDistributions", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.PlannedVisit", b =>
                {
                    ...
                    b.Property<string>("ProductsToPresent")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<string>("VisitObjective")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.HasIndex("PlanId", "PlannedDate");

                    b.ToTable("PlannedVisits", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.PriceListItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("MarketingMessages")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
            ...
            modelBuilder.Entity("Domain.Entities.ProductDocument", b =>
                {
                    ...
                    b.HasIndex("ProductId", "DocumentType");

                    b.HasIndex("ProductId", "IsCurrentVersion");
            ...
            modelBuilder.Entity("Domain.Entities.RepCustomerAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("RequiredVisitsPerMonth")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RepId", "CustomerId")
                        .IsUnique();

                    b.ToTable("RepCustomerAssignments", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.RepInventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RepId", "MaterialName")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("RepInventories", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.SurveyQuestion", b =>
                {
                    ...
                    b.Property<string>("QuestionTextLocal")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("Domain.Entities.SurveyResponse", b =>
                {
                    ...
                    b.Property<int>("RespondentRepId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Territory", b =>
                {
                    ...
                    b.Property<string>("MunicipalityIds")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
            ...
            modelBuilder.Entity("Domain.Entities.TerritoryAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TerritoryId", "RepId", "StartDate");

                    b.ToTable("TerritoryAssignments", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.VisitAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VisitAttachments", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.VisitNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.WholesalerDataImport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MatchedProductCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("UnmatchedCustomerCount")
                        .HasColumnType("int");

                    b.Property<int>("UnmatchedProductCount")
                        .HasColumnType("int");
                    ...
                    b.ToTable("WholesalerDataImports", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.WholesalerSalesRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsManuallyMatched")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("WholesalerSalesRecords", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.WholesalerStockRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WholesalerId", "ProductId", "ReportDate")
                        .IsUnique()
                        .HasFilter("[ProductId] IS NOT NULL");

                    b.ToTable("WholesalerStockRecords", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.BrandGroupMember", b =>
                {
                    b.HasOne("Domain.Entities.BrandGroup", "BrandGroup")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Domain.Entities.Cycle", b =>
                {
                    b.HasOne("Domain.Entities.SalesRepresentative", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Department", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Physician", "HeadPhysician")
                        .WithMany()
                        .HasForeignKey("HeadPhysicianId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Customer");

                    b.Navigation("HeadPhysician");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ExecutedVisit", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.PlannedVisit", "PlannedVisit")
                        .WithOne("ExecutedVisit")
                        .HasForeignKey("Domain.Entities.ExecutedVisit", "PlannedVisitId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Domain.Entities.SalesRepresentative", "Rep")
                        .WithMany("ExecutedVisits")
                        .HasForeignKey("RepId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Physician", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Customer", "Institution")
                        .WithMany("Physicians")
            ...
            modelBuilder.Entity("Domain.Entities.PlannedVisit", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.VisitPlan", "Plan")
            ...
            modelBuilder.Entity("Domain.Entities.SurveyAnswer", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.SurveyResponse", "Response")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Domain.Entities.SurveyResponse", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.SalesRepresentative", "RespondentRep")
                        .WithMany()
                        .HasForeignKey("RespondentRepId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Territory", b =>
                {
                    b.HasOne("Domain.Entities.Territory", "ParentTerritory")
            ...
            modelBuilder.Entity("Domain.Entities.WholesalerDataImport", b =>
                {
                    b.HasOne("Domain.Entities.Customer", "Wholesaler")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.WholesalerSalesRecord", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.WholesalerDataImport", "Import")
            ...
            modelBuilder.Entity("Domain.Entities.Brand", b =>
                {
                    b.Navigation("BrandGroupMembers");
